...
test_images = []
test_poses = []
filelist1 = sorted(glob.glob("/content/test_data/real_images/*.png"))
filelist2 = sorted(glob.glob("/content/test_data/real_label/*.png"))
filelist3 = sorted(glob.glob("/content/test_data/syn_images/*.png"))
...
test_poses = np.asarray(test_poses)
